...
const About = () => {
  ...
  // Handle tab click to scroll to content
  const handleTabClick = (index) => {
    const contentItem = document.querySelectorAll(`.${styles.contentItem}`)[index];
    if (contentItem) {
  ...
  return (
    <div>
      ...
      <div className={styles.ppmvnIntro}>
        ...
        <p><strong>Email:</strong> vanhanh@ppmvn.vn</p>
      ...
      <div className={styles.box} onClick={handlePlay}>
        <video
          ref={videoRef}
          width="100%"
          height="100%"
      ...
      <div className={styles.aboutList}>
        <div className={styles.aboutItem}>
          ...
          <p className={styles.text}>
            Đội ngũ nhân sự chủ chốt được đào tạo tại các trường đại học danh tiếng trong và ngoài nước, đáp ứng tiêu chuẩn cao của môi trường làm việc hiện đại.
          </p>
        </div>
        <div className={styles.aboutItem}>
          <div className={styles.imageDiv}>
            <img className={styles.img} src={`/assets/images/ab2.png`} />
          </div>
          <p className={styles.text}>
            Đội ngũ nhân sự chủ chốt được đào tạo tại các trường đại học danh tiếng trong và ngoài nước, đáp ứng tiêu chuẩn cao của môi trường làm việc hiện đại.
          </p>
        ...
        <div className={styles.aboutItem}>
          <div className={styles.imageDiv}>
            <img className={styles.img} src={`/assets/images/ab3.png`} />
          </div>
          <p className={styles.text}>
            Đội ngũ nhân sự chủ chốt được đào tạo tại các trường đại học danh tiếng trong và ngoài nước, đáp ứng tiêu chuẩn cao của môi trường làm việc hiện đại.
          </p>
        ...
        <div className={styles.aboutItem}>
          <div className={styles.imageDiv}>
            <img className={styles.img} src={`/assets/images/ab4.png`} />
          </div>
          <p className={styles.text}>
            Đội ngũ nhân sự chủ chốt được đào tạo tại các trường đại học danh tiếng trong và ngoài nước, đáp ứng tiêu chuẩn cao của môi trường làm việc hiện đại.
          </p>
          ...
          <div className={styles.aboutContent}>
            <div className={styles.contentItem}>
              ...
              <div className={styles.textContent}>
                ...
                <p>Trở thành đơn vị đào tạo và nghiên cứu khoa học hàng đầu trong lĩnh vực Ngân hàng, Tài chính, Công nghệ và các chuyên môn ưu tiên của phát triển kinh tế quan trọng tại khu vực. Là nơi hồi tụ tinh hoa trí thức, đào tạo sâu những giá trị thực nghiệm mang tính thời đại, ứng dụng công nghệ cao, trang bị sẵn sàng những kỹ năng kiến thức để cán bộ nhân viên học viên sẵn sàng với thời cuộc, vững vàng tiến tới tương lai, hiện thực hóa những giấc mơ cao đẹp.</p>
              </div>
            </div>
            <div className={styles.contentItem}>
              <div className={styles.imageContent}>
                <img className={styles.img} src='/assets/images/sumenh.jpg' />
              </div>
              <div className={styles.textContent}>
                <h3 className={styles.h3}>Sứ mệnh</h3>
                <p><strong>1. Với học viên và cộng đồng:</strong> Xây dựng môi trường học tập chuyên nghiệp, đa chiều và sáng tạo, đào tạo nguồn nhân lực chất lượng cao cho thị trường lao động có trình độ chuyên môn sâu về ngân hàng, tài chính và thích ứng linh hoạt trong kỷ nguyên số.<br /><strong>2. Với ngành giáo dục và công nghệ:</strong> Liên kết tri thức Việt Nam với thế giới thông qua việc thúc đẩy nghiên cứu ứng dụng và chuyển giao công nghệ đột phá, góp phần nâng cao hiệu quả hoạt động của ngân hàng, các tổ chức tài chính và các doanh nghiệp tăng cường tính bảo mật và tinh cậy.<br /><strong>3. Với đối tác:</strong> Xây dựng và duy trì quan hệ hợp tác minh bạch, bền vững, quy tụ trí tuệ và nguồn lực quốc tế nhằm tạo giá trị gia tăng và phát triển toàn diện.</p>
              </div>
            </div>
            <div className={styles.contentItem}>
              <div className={styles.imageContent}>
                <img className={styles.img} src='/assets/images/giatricotloi.png' />
              </div>
              <div className={styles.textContent}>
      ...
      <div className={styles.project}>
        ...
        <div className={styles.listProject}>
          {[...Array(8)].map((_, idx) => (
            <div className={styles.itemProject} key={idx}>
