        ...
        <div className={styles.contactInfo}>
          <div className={styles.contactInfoBlock}>
            ...
            <div className={styles.region}>
              <h3>Miền Nam</h3>
              <p>Hotline: <strong>091 803 7466</strong></p>
              <p>Email: <strong>recruitment@acfc.com.vn</strong></p>
            </div>

            <div className={styles.region}>
              <h3>Miền Bắc</h3>
              <p>Hotline: <strong>090 485 5042</strong></p>
              <p>Email: <strong>recruitment.hn@acfc.com.vn</strong></p>
            </div>

            <div className={styles.socialIcons}>
              <div className={styles.icon}>
                <i className="fa-brands fa-facebook-f"></i>
                <a href="#" aria-label="ACFC Facebook">ACFC Fanpage</a>
              </div>
              <div className={styles.icon}>
                <i className="fa-brands fa-linkedin-in"></i>
                <a href="#" aria-label="ACFC LinkedIn">ACFC Linkedin</a>
              </div>
              <div className={styles.icon}>
                <i className="fa-brands fa-tiktok"></i>
                <a href="#" aria-label="ACFC TikTok">ACFC Tiktok</a>
              </div>
            </div>
          </div>
        </div>
